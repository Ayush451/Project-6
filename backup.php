<?php
// added the connection and check if the POST are clicked
include 'connect.php';
...
<body>
<?php 
    include 'Intent_History_all.php';
?>
                            ...
                            <tbody class="bg-white border border-3 ">
                                ...
                                if ($result) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>
                                            <button class= "btn bg-warning badge-pill" ><a href="edit.php?editid=' . $id . '" class="text-light text-decoration-none" > Edit</button>
